...
for arquivo_pdf in os.listdir(pasta_pdf):
    if arquivo_pdf.endswith('.pdf'):
        ...
        if "Tipo 5 - (FEDERACAO DE FUTEBOL DO ESTADO DO RIO DE JANEIRO)" in tipo_sumario:
            ...
            resultados.append({'Jogo': arquivo_pdf, 'Tipo de Sumário': tipo_sumario, 'Próxima Linha': prox_linha2, 'Mandante': ref2,
                              'Visitante': ref3, 'RECEITA': ref5})
...
nome_arquivo_excel = 'sandbox3.xlsx'
